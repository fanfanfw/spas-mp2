...
<head>
    ...
    <title>Mahasiswa - Sistem Pengelolaan Administrasi Surat</title>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Sistem Pengelolaan Administrasi Surat</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="header-right-info">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                  ...
                                                  <?php }else{ ?>
                                                    <img src="../gambar/petugas/<?php echo $profil['mahasiswa_foto'] ?>" style="width: 20px;height: 20px">
                                                <?php } ?>
