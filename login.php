...
<head>
    ...
    <title>Login | Sistem Pengelolaan Administrasi Surat</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>SISTEM PENGELOLAAN</h3>
                <h4>ADMINISTRASI SURAT</h4>

                <br>

                <p>Silahkan login untuk mengelola surat.</p>
                    ...
                    <div class="panel-body">
                        ...
                        <form action="periksa_login.php" method="POST" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="NIM" title="Please enter you username" required="required" autocomplete="off" name="username" id="username" class="form-control">
                            </div>
                            <div class="form-group">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Pengelolaan Administrasi Surat (SPAS)</p>
            </div>
        </div>   
    </div>
